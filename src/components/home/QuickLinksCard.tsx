...
const quickLinks = [
  ...
  { icon: BarChart3, label: "Sale Report", path: "/reports", color: "bg-success/10 text-success" },
  { icon: Settings, label: "Transaction Settings", path: "/settings", color: "bg-warning/10 text-warning" },
  { icon: ArrowRight, label: "Show All", path: "/transactions", color: "bg-accent text-foreground" },
];
