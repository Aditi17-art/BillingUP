...
const partyQuickLinks = [
  { icon: Network, label: "Network", path: "/parties/statement", color: "bg-gradient-to-br from-purple-400 to-pink-400 text-white" },
  { icon: FileText, label: "Party Statement", path: "/parties/statement", color: "bg-gradient-to-br from-blue-400 to-cyan-400 text-white" },
  { icon: Settings, label: "Party Settings", path: "/settings/party", color: "bg-gradient-to-br from-amber-400 to-orange-400 text-white" },
  { icon: ArrowRight, label: "Show All", path: "#", color: "bg-gradient-to-br from-emerald-400 to-teal-400 text-white", isShowAll: true },
];
...
export const PartyQuickLinks = () => {
  ...
  return (
    <>
      ...
      <MoreOptionsSheet open={showMoreOptions} onOpenChange={setShowMoreOptions} />
    </>
  );
};
